...
#SBATCH -o FINAL_res18%j.out                          # File to which STDOUT will be written, %j inserts jobid
#SBATCH -e FINAL_res18%j.err
# SBATCH --constraint=a100|h100                          # File to which STDERR will be written, %j inserts jobid
